 ...
 * 
 * Knowledge & Understanding:    17/20
 *    Percent Grade for
 *    how well student 
 *    followed standards:      85%
 *
 *    Make sure to be more descriptive with your @param tags
 *    Your method comment blocks must start with the name of the method. Some of yours do not.
 *    Missing comment blocks for switchCreature and switchedIn in Creature
 *    Some incorrect method descriptions in comment blocks
 *
 * Problem-Solving:              19/20
 *    Percent Grade for 
 *    completion of 
 *    assignment requirements: 95%
 *
 *    List of incorrect TODOs: 
 *        TODO 52 for all playerOneCreatures
 *        Ivysaur is missing its attack damage for attack two when attacking a Water type
 *        Ivysaur's switchCreature method's idx if statements are incorrect
 * 
 */
...
public class CreatureWorld extends World
{
     ...
     */
    /**
     * changePlayerOne is the method that change player one to a different creature and reset 
     * the switch menu and fight menu
     * 
     * @param a String Variable that represent The player one Creature (which player one creature?)
     ...
     */
    /**
     * changePlayerTwo is the method that change player two to a different creature and reset 
     * the switch menu and fight menu
     * 
     * @param a String Variable that represent The player two Creature (which player two creature?)
     * @return Does not return anything
     */
     ...
     */
    /**
     * (getNewOneCreature) Gets the creature defined at the current index of PlayerOneCreatures array
     * 
     * @param integer that represet the index of the PlayerOneCreatures array (and what is that index used for?)
     * @return Creature that represent the creatures (represents which creature?)
     */
     ...
     */
    /**
     * (getNewTwoCreature) Gets the creature defined at the current index of PlayerTwoCreatures array
     * 
     * @param integer that represet the index of the PlayerTwoCreatures array (and what is that index used for?)
     * @return Creature that represent the creatures (represents which creature?)
     */
